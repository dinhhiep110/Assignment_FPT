 ...
 * @author Duy Hiep
 */
public class SaigonHeatController extends BaseRequiredAuthController {
    ...
    protected void proccessGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Match> schedule = tdb.getSchedule(1);
        request.setAttribute("area", area);
        request.setAttribute("schedule", schedule);
        request.getRequestDispatcher("../vba/jsp/sgh.jsp").forward(request, response);
    }
