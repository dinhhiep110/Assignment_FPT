 ...
 * @author Duy Hiep
 */
public class DaNangDragonController extends BaseRequiredAuthController {
    ...
    protected void proccessGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Match> schedule = tdb.getSchedule(3);
        request.setAttribute("area", area);
        request.setAttribute("schedule", schedule);
        request.getRequestDispatcher("../vba/jsp/dnd.jsp").forward(request, response);
    }
