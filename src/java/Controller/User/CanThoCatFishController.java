 ...
 * @author Duy Hiep
 */
public class CanThoCatFishController extends BaseRequiredAuthController {
    ...
    protected void proccessGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Match> schedule = tdb.getSchedule(5);
        request.setAttribute("area", area);
        request.setAttribute("schedule", schedule);
        request.getRequestDispatcher("../vba/jsp/ctc.jsp").forward(request, response);
    }
