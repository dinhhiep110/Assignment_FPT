 ...
 * @author Duy Hiep
 */
public class HaNoiBuffaloesController extends BaseRequiredAuthController {
    ...
    protected void proccessGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Match> schedule = tdb.getSchedule(6);
        request.setAttribute("area", area);
        request.setAttribute("schedule", schedule);
        request.getRequestDispatcher("../vba/jsp/hnb.jsp").forward(request, response);
    }
